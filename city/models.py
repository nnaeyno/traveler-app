...
class Place(models.Model):
    ...
    description = models.TextField(verbose_name="Place Description", blank=True)
...
class PlaceRating(models.Model):
    ...
    user = models.ForeignKey(
        settings.AUTH_USER_MODEL, on_delete=models.CASCADE, related_name="place_ratings"
    )
...
class UserPlaceVisit(models.Model):
    ...
    user = models.ForeignKey(
        settings.AUTH_USER_MODEL, on_delete=models.CASCADE, related_name="place_visits"
    )
