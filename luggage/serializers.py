...
from luggage.models import TravelDocument, ChecklistItem, Trip
...
class ChecklistItemSerializer(serializers.ModelSerializer):
    ...
    def validate_trip_id(self, value):
        ...
        if value.user != self.context['request'].user:
            raise serializers.ValidationError("You don't have permission to add items to this trip.")
        return value
...
class TravelDocumentSerializer(serializers.ModelSerializer):
    ...
    def validate_trip_id(self, value):
        ...
        """
        if value.user != self.context['request'].user:
            raise serializers.ValidationError("You don't have permission to add documents to this trip.")
        return value
...
class TripSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            'destination', 'destination_id', 'created_at',
